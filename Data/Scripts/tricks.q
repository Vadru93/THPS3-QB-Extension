...
LM_GUI_bTrickNotifications = 0
LM_Controls_bWalliePlant = 1
LM_Controls_bRevert = 1
...
SCRIPT WallRide
	...
	IF IsTrue LM_Controls_bWalliePlant
...
SCRIPT Land
	...
	IF SpeedGreaterThan 500
		IF YawBetween (60, 120)
			...
			ELSE
				IF IsTrue LM_GUI_bTrickNotifications
